...
"""
批量学习器 V3 - AI驱动版本
使用AI进行智能分类和元素提取，支持多种格式，自动质量检查，生成详细报告
"""
...
from universal_learner_v3 import AIBasedLearner
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='批量学习提示词 (V3 - AI驱动)')
    ...
    if not os.environ.get('ANTHROPIC_API_KEY'):
        print("\n⚠️  警告: 未设置 ANTHROPIC_API_KEY 环境变量")
        print("将使用fallback模式（效果可能不佳）")
        print("建议: export ANTHROPIC_API_KEY='your-api-key'\n")

    batch_learner = BatchLearnerV3(args.db)
